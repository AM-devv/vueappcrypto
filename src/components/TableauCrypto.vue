           ...
           <table class="table shadow table-light table-striped table-hover">
            ...
            <tbody>
                <tr class="align-middle" v-for="cryp in SearchCryps.slice(0,limit)" :key="cryp.id">
                    ...
                    <td>{{ cryp.current_price.toLocaleString() }} $</td>
                    <td v-if="cryp.price_change_percentage_1h_in_currency != null" :class="cryp.price_change_percentage_1h_in_currency > 0 ? 'text-success'  : 'text-danger' ">{{ cryp.price_change_percentage_1h_in_currency.toFixed(3) }} %</td>
                    <td v-if="cryp.price_change_percentage_24h != null" :class="cryp.price_change_percentage_24h > 0 ? 'text-success'  : 'text-danger' ">{{ cryp.price_change_percentage_24h.toFixed(3) }} %</td>
                    <td v-if="cryp.price_change_percentage_7d_in_currency != null" :class="cryp.price_change_percentage_7d_in_currency > 0 ? 'text-success'  : 'text-danger' ">{{ cryp.price_change_percentage_7d_in_currency.toFixed(3) }} %</td>
